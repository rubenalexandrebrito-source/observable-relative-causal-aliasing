...
Amostra: famílias II elegíveis, semente exploratória NOVA 910000002
...
SEED_EXPLORATORIO = 910000002
N_ALVO = 5000
MAX_TENTATIVAS = 200000
TEMPO_MAX_S = 420
SAIDA = DST + "/prevalencia/prevalencia-cancelamento-II-lote2.json"
...
def main():
    ...
    saida = {
        ...
        "fluxo": "SeedSequence(910000002).spawn(4)[0] = theta nuclear (como gerar_lote); [1..3] nao usados",
